...
class GA(object):
    ...
    def genetic_algorithm(self,pop_size, num_generations, crossover_prob,mut_prob, tournament_size):
        Gen = []
        BG = []
        BO = []
        BS = []
...
if __name__ == '__main__':
    ...
    obv = GA('A1')
    best_solution = obv.genetic_algorithm(pop_size=25, num_generations=20, crossover_prob=0.7,mut_prob=0.3,tournament_size=3)
